...
using Holographic_DirectX_11_App.Common;
using System.Threading.Tasks;
using Windows.Foundation;
using System.Collections.Generic;

#if DRAW_SAMPLE_CONTENT
using Holographic_DirectX_11_App.Content;
#endif

namespace Holographic_DirectX_11_App
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class Holographic_DirectX_11_AppMain : IDisposable
    {
        ...
        public Holographic_DirectX_11_AppMain(DeviceResources deviceResources)
        {
